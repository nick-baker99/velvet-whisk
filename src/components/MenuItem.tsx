  ...
  return (
    <article className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border border-[#F4F7D9] rounded-2xl overflow-hidden group">
      <div className="overflow-hidden h-64">
        <img src={require(`../assets/images/treats/${image}`).default} alt={title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
      </div>
      <div className="p-4">
